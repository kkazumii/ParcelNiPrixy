...
namespace ParcelTrackingSystem
{
    ...
    public class PaymentsForm : BaseForm
    {
        ...
        private void Build()
        {
            ...
            var btnEdit = MakeBtn("✏  Edit Status", Color.FromArgb(250, 179, 135), 0, 44, 115);
            var btnRef = MakeBtn("🔄", Color.FromArgb(49, 50, 68), 0, 44, 36);
            AnchorRowRight(pnlContent, 44, btnEdit, btnRef);
    ...
    public class AuditLogForm : BaseForm
    {
        ...
        private void Build()
        {
            ...
            var btnRef = MakeBtn("🔄 Refresh", Color.FromArgb(49, 50, 68), 0, 44, 95);
            AnchorRowRight(pnlContent, 44, btnRef);
            btnRef.Click += (s, e) => Load();
